...
foreach ($file in @('geometry_readout.py','surface_evidence.py','freeform_evidence.py')) {
  Copy-Item -LiteralPath (Join-Path $workspace "readout/$file") -Destination (Join-Path $resources 'readout') -Force
}
